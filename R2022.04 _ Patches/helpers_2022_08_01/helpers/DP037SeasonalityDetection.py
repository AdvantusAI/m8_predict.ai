...
class Seasonality_Features:
    ...
    def TimeSeriesFeatures(self):
        ...
        try:
            features = stl_features(tsdata.values, self.freq)
            spec_entropy = entropy(tsdata.values, self.freq)["entropy"]
...
def calc_seasonality(
    ...
    try:
        ...
        result[seasonality_l1_col] = result[seasonality_l1_col].fillna("No")
