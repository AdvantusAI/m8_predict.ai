...
def log_inputs_and_outputs(fn):
    ...
    def func(*args, **kwargs):
        ...
        logger.info(
            "--- Invoking {} with arguments below ---".format(function_name)
        )
        ...
        logger.info("---------- all inputs logged successfully ----------")
...
def main(param1, param2, input_df):
    test1 = pd.DataFrame(
...
if __name__ == "__main__":
    ...
    main(param1="hancel", param2="rahul", input_df=df1)
